...
public val MangalaWalletPack.BackgroundDefaultQrDark: ImageVector
    get() {
        if (_backgroundDefaultQrDark != null) {
            return _backgroundDefaultQrDark!!
        }
        _backgroundDefaultQrDark = ImageVector.Builder(
            name = "BackgroundDefaultQrDark",
            ...
            group {
                // --- THAY ĐỔI 1: Nền gradient chính được chuyển sang tông màu tối ---
                path(
                    fill = Brush.linearGradient(
                        0.0f to Color(0xFF211F25), // Màu tối hơn ở trên
                        1.0f to Color(0xFF1A1A1A), // Màu tối hơn ở dưới
                        start = Offset(187.5f, 0.0f),
                        end = Offset(187.5f, 812.0f)
                    ),
                    stroke = null,
                ...
                // --- THAY ĐỔI 2: Tăng nhẹ alpha cho các khối màu để nổi bật hơn ---
                path(
                    fill = SolidColor(Color(0xFFFE9923)), stroke = null, fillAlpha = 0.3f,
                    strokeAlpha = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.EvenOdd
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFFECD3D)), stroke = null, fillAlpha = 0.3f,
                    strokeAlpha = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.EvenOdd
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFFEA832)), stroke = null, fillAlpha = 0.3f,
                    strokeAlpha = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.EvenOdd
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFC85929)), stroke = null, fillAlpha = 0.3f,
                    strokeAlpha = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.NonZero
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFFE9923)), stroke = null, fillAlpha = 0.2f,
                    strokeAlpha = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.EvenOdd
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFFECD3D)), stroke = null, fillAlpha = 0.2f,
                    strokeAlpha = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.EvenOdd
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFFEA832)), stroke = null, fillAlpha = 0.2f,
                    strokeAlpha = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.EvenOdd
                ) {
                ...
                path(
                    fill = SolidColor(Color(0xFFC85929)), stroke = null, fillAlpha = 0.2f,
                    strokeAlpha = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = StrokeCap.Butt,
                    strokeLineJoin = StrokeJoin.Miter, strokeLineMiter = 4.0f, pathFillType = PathFillType.Companion.NonZero
                ) {
...
private var _backgroundDefaultQrDark: ImageVector? = null
