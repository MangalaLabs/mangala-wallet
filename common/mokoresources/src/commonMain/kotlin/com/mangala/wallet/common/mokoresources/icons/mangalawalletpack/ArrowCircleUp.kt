...
public val MangalaWalletPack.ArrowCircleUp: ImageVector
    get() {
        if (arrowCircleUp != null) {
            return arrowCircleUp!!
        }
        arrowCircleUp = Builder(name = "Arrow-up", defaultWidth = 18.0.dp, defaultHeight = 18.0.dp,
...
private var arrowCircleUp : ImageVector? = null
