...
struct AnyDownloadListRepresentable: DownloadListRepresentable, Comparable {
    ...
    var fileSizeInBytes: Int { wrappedRepresentable.fileSizeInBytes }
...
extension URL: DownloadListRepresentable {
    ...
    var fileSizeInBytes: Int { (try? resourceValues(forKeys: [.fileSizeKey]))?.fileSize ?? 0 }
...
extension Download: DownloadListRepresentable {
    ...
    var fileSizeInBytes: Int { Int(totalBytesWritten) }
