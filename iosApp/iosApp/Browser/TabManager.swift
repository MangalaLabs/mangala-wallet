...
class TabManager {
    ...
    private func buildController(forTab tab: Tab, url: URL?) -> TabViewController {
        ...
        controller.rpcUrl = self.rpcUrl
        controller.chainId = self.chainId
        controller.accountId = self.accountId
        controller.sessionsProvider = self.sessionsProvider
//        controller.startSession()
        os_log("2022 persistent ")
