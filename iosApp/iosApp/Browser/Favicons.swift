...
public class Favicons {
    ...
    func replaceBookmarksFavicon(forDomain domain: String?, withImage image: UIImage) {
        ...
        guard let domain = domain,
              let resource: Kingfisher.ImageResource = defaultResource(forDomain: domain),
    ...
    func isFaviconCachedForBookmarks(forDomain domain: String, resource: Kingfisher.ImageResource) -> Bool {
    ...
    func defaultResource(forDomain domain: String?) -> Kingfisher.ImageResource? {
        return FaviconsHelperCore.defaultResource(forDomain: domain, sourcesProvider: sourcesProvider)
    }
