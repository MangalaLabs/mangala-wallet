...
public class Database {
    ...
    convenience init() {
        ...
        let coreBundleIdentifier = Bundle.main.object(forInfoDictionaryKey: "CFBundleIdentifier") as? String
        let coreBundle = Bundle(identifier: coreBundleIdentifier!)! // Force-unwrapping this so we know this immediately when we config it wrong
