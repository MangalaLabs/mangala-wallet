...
extension WKWebViewConfiguration {
    ...
    public static func make(forType type: WebViewType, address: AlphaWallet.Address, messageHandler: WKScriptMessageHandler) -> WKWebViewConfiguration {
        ...
        case .dappBrowser(let server):
            ...
            let dapp = javaScriptForDappBrowser(server: server, address: address)
...
// swiftlint:disable function_body_length
    fileprivate static func javaScriptForDappBrowser(server: RPCServer, address: AlphaWallet.Address) -> String {
        print("1991 server.web3InjectedRpcURL.absoluteString \(server.web3InjectedRpcURL.absoluteString.count)")
        print("1991 address.eip55String \(address.eip55String.count)")
        print("1991 server.chainID \(server.chainID)")
        return """
