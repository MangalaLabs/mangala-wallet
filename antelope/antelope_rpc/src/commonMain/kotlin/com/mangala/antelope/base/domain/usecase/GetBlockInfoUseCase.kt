...
class GetBlockInfoUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, request: GetBlockInfoRequest): GetBlockInfoResponse? {
        val result = repository.getBlockInfo(blockchainType, request)
