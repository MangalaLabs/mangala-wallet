...
class GetCodeUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, request: GetCodeRequest): GetCodeResponse? {
        val result = repository.getCode(blockchainType, request)
