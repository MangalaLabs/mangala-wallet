...
class GetRawCodeAndAbiUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, request: GetRawCodeAndAbiRequest): GetRawCodeAndAbiResponse? {
        val result = repository.getRawCodeAndAbi(blockchainType, request)
