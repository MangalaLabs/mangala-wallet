...
class GetBlockUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, request: GetBlockRequest): GetBlockResponse? {
        val result = repository.getBlock(blockchainType, request)
