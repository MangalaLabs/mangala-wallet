...
import com.mangala.antelope.base.core.error.serializationProvider.SerializationProviderError

/**
 * Error class is used when there is an exception while attempting to call serializeTransaction() of
 * Serialization Provider
 */
class SerializePackedTransactionError : SerializationProviderError {
    constructor()
