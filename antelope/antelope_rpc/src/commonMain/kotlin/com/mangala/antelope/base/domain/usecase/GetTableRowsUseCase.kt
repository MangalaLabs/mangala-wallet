...
class GetTableRowsUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, request: GetTableRowsRequest): GetTableRowsResponse? {
        val result = repository.getTableRows(blockchainType, request)
