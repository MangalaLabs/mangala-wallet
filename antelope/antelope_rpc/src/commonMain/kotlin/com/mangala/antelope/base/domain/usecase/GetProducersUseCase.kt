...
class GetProducersUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, request: GetProducersRequest): GetProducersResponse? {
        val result = repository.getProducers(blockchainType, request)
