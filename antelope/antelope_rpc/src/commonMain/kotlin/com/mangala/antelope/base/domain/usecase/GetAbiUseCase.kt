...
class GetAbiUseCase(private val repository: AntelopeRepository) {
    suspend operator fun invoke(blockchainType: BlockchainType, accountName: String): GetAbiResponse? {
        val result = repository.getAbi(blockchainType, GetAccountRequest(accountName))
