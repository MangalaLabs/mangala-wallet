...
class DepositRexArgsSquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) : Squishable<DepositRexArgs> {
    override fun squish(depositRexArgs: DepositRexArgs, writer: ByteWriter) {
        writer.putAccountName(depositRexArgs.getAccount)
        writer.putAsset(depositRexArgs.getAmount)
    }
}
