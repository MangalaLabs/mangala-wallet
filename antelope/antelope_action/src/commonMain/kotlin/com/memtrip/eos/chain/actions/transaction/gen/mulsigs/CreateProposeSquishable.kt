...
class CreateProposeSquishable internal constructor(
    private val abiBinaryGen: AbiBinaryGenTransactionWriter,
) : Squishable<CreateProposeAbi> {
    override fun squish(createProposeAbi: CreateProposeAbi, byteWriter: ByteWriter) {
        abiBinaryGen.squishCreateProposeAbi(createProposeAbi)
    }
}
