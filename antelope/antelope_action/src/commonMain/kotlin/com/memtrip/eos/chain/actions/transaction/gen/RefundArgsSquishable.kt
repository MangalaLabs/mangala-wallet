...
class RefundArgsSquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<RefundArgs> {
    override fun squish(refundargs: RefundArgs, byteWriter: ByteWriter) {
        byteWriter.putAccountName(refundargs.getOwner)
    }
}
