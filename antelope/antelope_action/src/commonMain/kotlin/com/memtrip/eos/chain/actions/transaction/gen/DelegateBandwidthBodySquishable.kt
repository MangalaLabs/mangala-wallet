...
class DelegateBandwidthBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<DelegateBandwidthBody> {
    override fun squish(delegatebandwidthbody: DelegateBandwidthBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishDelegateBandwidthArgs(delegatebandwidthbody.getArgs)
    }
}
