...
class RentViaRexBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) : Squishable<RentViaRexBody>{
    override fun squish(rentViaRexBody: RentViaRexBody, writer: ByteWriter) {
        abiBinaryGen.squishRentViaRexArgs(rentViaRexBody.getArgs)
    }
}