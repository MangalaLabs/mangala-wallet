...
class SellRamBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<SellRamBody> {
    override fun squish(sellrambody: SellRamBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishSellRamArgs(sellrambody.getArgs)
    }
}
