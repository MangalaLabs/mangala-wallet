...
class TransferBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<TransferBody> {
    override fun squish(transferbody: TransferBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishTransferArgs(transferbody.getArgs)
    }
}
