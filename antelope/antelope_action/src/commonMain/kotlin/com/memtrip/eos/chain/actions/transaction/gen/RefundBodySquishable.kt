...
class RefundBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<RefundBody> {
    override fun squish(refundbody: RefundBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishRefundArgs(refundbody.getArgs)
    }
}
