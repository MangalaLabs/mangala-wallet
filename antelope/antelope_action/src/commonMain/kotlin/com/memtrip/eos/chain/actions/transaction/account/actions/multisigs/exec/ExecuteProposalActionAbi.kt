 ...
 */
package com.memtrip.eos.chain.actions.transaction.account.actions.multisigs.exec

import com.memtrip.eos.abi.writer.Abi
import com.memtrip.eos.abi.writer.AccountNameCompress

@Abi
data class ExecuteProposalActionAbi(
    val proposer: String,
    ...
    val getExecuter: String
        @AccountNameCompress get() = executer
}