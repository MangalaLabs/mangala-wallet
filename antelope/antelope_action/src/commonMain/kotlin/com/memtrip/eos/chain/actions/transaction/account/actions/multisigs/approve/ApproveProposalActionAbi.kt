 ...
 */
package com.memtrip.eos.chain.actions.transaction.account.actions.multisigs.approve

import com.memtrip.eos.abi.writer.Abi
import com.memtrip.eos.abi.writer.AccountNameCompress

@Abi
class ApproveProposalActionAbi(
    val proposer: String,
    val proposalName: String,
    val level: ApproveLevelAbi,
) {
