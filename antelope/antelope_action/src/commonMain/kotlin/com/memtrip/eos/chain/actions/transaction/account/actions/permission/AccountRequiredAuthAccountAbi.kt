...
@Abi
data class AccountRequiredAuthAccountAbi(
    val permission: RequiredAuthAccountPermissionAbi,
    val weight: Short
) {
    val getPermission: RequiredAuthAccountPermissionAbi
        @ChildCompress get() = permission

    val getWeight: Short
        @AccountNameCompress get() = weight
}