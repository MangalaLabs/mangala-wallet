...
class BuyRamBytesBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<BuyRamBytesBody> {
    override fun squish(buyrambytesbody: BuyRamBytesBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishBuyRamBytesArgs(buyrambytesbody.getArgs)
    }
}
