...
class DepositRexBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<DepositRexBody> {

    override fun squish(depositRexBody: DepositRexBody, writer: ByteWriter) {
        abiBinaryGen.squishDepositRexArgs(depositRexBody.getArgs)
    }
}
