...
class NewAccountBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<NewAccountBody> {
    override fun squish(newaccountbody: NewAccountBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishNewAccountArgs(newaccountbody.getArgs)
    }
}
