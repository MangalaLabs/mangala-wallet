...
class ProposalTransactionAbiSquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<ProposalTransactionAbi> {
    override fun squish(transactionabi: ProposalTransactionAbi, byteWriter: ByteWriter) {
        ...
        abiBinaryGen.squishCollectionProposalActionAbi(transactionabi.getActions, byteWriter)
