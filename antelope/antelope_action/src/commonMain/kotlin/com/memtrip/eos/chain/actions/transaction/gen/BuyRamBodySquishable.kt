...
class BuyRamBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<BuyRamBody> {
    override fun squish(buyrambody: BuyRamBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishBuyRamArgs(buyrambody.getArgs)
    }
}
