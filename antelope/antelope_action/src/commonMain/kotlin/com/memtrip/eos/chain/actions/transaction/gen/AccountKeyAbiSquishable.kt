...
class AccountKeyAbiSquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<AccountKeyAbi> {
    override fun squish(accountkeyabi: AccountKeyAbi, byteWriter: ByteWriter) {
        byteWriter.putPublicKey(EosPublicKey(accountkeyabi.getKey))
        byteWriter.putShort(accountkeyabi.getWeight)
    }
}
