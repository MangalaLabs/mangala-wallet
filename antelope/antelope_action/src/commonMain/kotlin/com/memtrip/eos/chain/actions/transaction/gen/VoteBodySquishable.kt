...
class VoteBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<VoteBody> {
    override fun squish(votebody: VoteBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishVoteArgs(votebody.getArgs)
    }
}
