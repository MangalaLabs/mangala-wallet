...
class ActionAbiSquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<ActionAbi> {
    override fun squish(actionabi: ActionAbi, byteWriter: ByteWriter) {
