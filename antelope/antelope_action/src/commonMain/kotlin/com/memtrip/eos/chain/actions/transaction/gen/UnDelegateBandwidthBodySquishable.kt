...
class UnDelegateBandwidthBodySquishable internal constructor(private val abiBinaryGen: AbiBinaryGenTransactionWriter) :
    Squishable<UnDelegateBandwidthBody> {
    override fun squish(undelegatebandwidthbody: UnDelegateBandwidthBody, byteWriter: ByteWriter) {
        abiBinaryGen.squishUnDelegateBandwidthArgs(undelegatebandwidthbody.getArgs)
    }
}
