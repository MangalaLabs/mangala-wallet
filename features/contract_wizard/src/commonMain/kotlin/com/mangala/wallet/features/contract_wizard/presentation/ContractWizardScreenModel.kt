package com.mangala.wallet.features.contract_wizard.presentation

import com.mangala.wallet.features.contract_wizard.data.model.ContractWizardRequest
import com.mangala.wallet.features.contract_wizard.data.model.Features
...
import com.mangala.wallet.features.contract_wizard.data.model.Metadata
...
class ContractWizardScreenModel(
    ...
    private suspend fun getAccounts() {
        ...
        result?.let { list ->
            _uiState.update {
                ContractWizardScreenUiState.Data(
                    accounts = list,
