...
import com.mangala.wallet.uniswap.PairError
...
class Pair(
    ...
    fun tokenAmountOut(tokenAmountIn: TokenAmount): TokenAmount {
        ...
        val amountInWithFee = tokenAmountIn.rawAmount * BigInteger.fromInt(997)
        val numerator = amountInWithFee * reserveOut.rawAmount
        val denominator = reserveIn.rawAmount * BigInteger.fromInt(1000) + amountInWithFee
    ...
    fun tokenAmountIn(tokenAmountOut: TokenAmount): TokenAmount {
        ...
        val numerator = reserveIn.rawAmount * amountOut * BigInteger.fromInt(1000)
        val denominator = (reserveOut.rawAmount - amountOut) * BigInteger.fromInt(997)
