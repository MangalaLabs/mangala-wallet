...
class GenerateTransferRamSignRequestUseCase(
    ...
    suspend operator fun invoke(
        ...
        return constructSignRequest(
            ...
            constructActions = { authorization ->
                val transferAction = SignTransactionRequest.Action.TransferRam(
            ...
            signTransactionType = SignTransactionType.TRANSFER_RAM
        )
    }
}