...
class GenerateApproveProposalUseCase(
    ...
    suspend operator fun invoke(
        ...
        return constructSignRequest(
            ...
            constructActions = { authorization ->
                val transferAction = SignTransactionRequest.Action.ApproveProposal(
            ...
            signTransactionType = SignTransactionType.APPROVE_PROPOSAL
        )
    }
}
