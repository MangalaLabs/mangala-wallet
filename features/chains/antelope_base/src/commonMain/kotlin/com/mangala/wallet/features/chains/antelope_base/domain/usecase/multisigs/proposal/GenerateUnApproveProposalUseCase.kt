...
class GenerateUnApproveProposalUseCase(
    ...
    suspend operator fun invoke(
        ...
        return constructSignRequest(
            ...
            constructActions = { authorization ->
                val transferAction = SignTransactionRequest.Action.UnApproveProposal(
            ...
            signTransactionType = SignTransactionType.UN_APPROVE_PROPOSAL
        )
    }
}
