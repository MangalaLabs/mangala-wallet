...
class ExecuteProposalUseCase(
    private val generateExecuteProposalUseCase: GenerateExecuteProposalUseCase,
    ...
    suspend fun pushExecuteProposal(
        ...
        return constructAndPushTransaction(
            ...
            generateExecuteProposalUseCase(
                blockchainType = blockchainType,
    ...
    suspend fun requestExecuteProposal(
        blockchainType: BlockchainType,
        proposerAccountName: String,
        proposalName: String,
        accountPermissionExecuted: String,
