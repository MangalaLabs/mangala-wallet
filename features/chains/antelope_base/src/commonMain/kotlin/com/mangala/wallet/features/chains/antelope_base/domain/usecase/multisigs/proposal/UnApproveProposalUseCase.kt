...
class UnApproveProposalUseCase(
    private val generateUnApproveProposalUseCase: GenerateUnApproveProposalUseCase,
    ...
    suspend fun pushUnApproveProposal(
        ...
        return constructAndPushTransaction(
            ...
            generateUnApproveProposalUseCase(
                blockchainType = blockchainType,
    ...
    suspend fun requestUnApproveProposal(
        blockchainType: BlockchainType,
        proposerAccountName: String,
        proposalName: String,
        accountPermissionExecuted: String,
