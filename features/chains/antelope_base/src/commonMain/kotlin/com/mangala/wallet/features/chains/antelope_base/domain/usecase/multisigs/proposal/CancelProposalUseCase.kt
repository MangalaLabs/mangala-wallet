...
class CancelProposalUseCase(
    private val generateCancelProposalUseCase: GenerateCancelProposalUseCase,
    ...
    suspend fun pushCancelProposal(
    ...
    suspend fun requestCancelProposal(
        blockchainType: BlockchainType,
        proposerAccountName: String,
        proposalName: String,
        accountPermissionExecuted: String,
