...
class GenerateCancelProposalUseCase(
    ...
    suspend operator fun invoke(
        ...
        return constructSignRequest(
            ...
            constructActions = { authorization ->
                val transferAction = SignTransactionRequest.Action.CancelProposal(
            ...
            signTransactionType = SignTransactionType.CANCEL_PROPOSAL
        )
    }
}
