package com.mangala.wallet.features.chains.antelope.presentation.proposal.approvals.detail
...
import com.mangala.wallet.features.chains.antelope.presentation.proposal.myProposal.detail.ConfirmationDialog
...
class ApprovalProposalDetailScreen(
    ...
    override val screenName: String =
        MangalaAnalytics.Screens.ANTELOPE_MULTISIG_APPROVAL_PROPOSAL_DETAIL
    override val screenClassName: String = ApprovalProposalDetailScreen::class.simpleName.orEmpty()
    ...
    @Composable
    fun ApprovalProposalDetailScreen(
        navigator: Navigator,
        proposalName: String,
        ...
        MaxSizeBox(Modifier.background(MaterialTheme.mangalaColors.bg).imePadding().navigationBarsPadding()) {
            when (uiState) {
    ...
    @Composable
    private fun ApprovalProposalScreen(
        proposalName: String,
                ...
                Scaffold(
                    ...
                    topBar = {
                        ProposalDetailHeader(
                            ...
                            proposalDetail,
                            onBackClicked,
                            MR.strings.title_proposal_details_approval_proposal_detail.desc()
                                .localized(),
                    ...
                    content = { innerPadding ->
                        ApprovalProposalDetailScreenContent(
                            proposalDetail,
                            {
                                scope.launch {
    ...
    @Composable
    private fun ApprovalProposalDetailScreenContent(
        proposalDetail: ProposalDetail,
    ...
    fun ApprovalOverview(proposalDetail: ProposalDetail, onSeeDetailApprovalsClicked: () -> Unit) {
        Column(
            ...
            Column(
                ...
                Text(
                    text = MR.strings.message_proposal_details_approval_request.desc().localized(),
