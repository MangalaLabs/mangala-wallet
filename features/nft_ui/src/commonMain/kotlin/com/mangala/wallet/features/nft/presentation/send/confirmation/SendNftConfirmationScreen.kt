...
internal class SendNftConfirmationScreen(
    ...
    override fun Content() {
        ...
        MangalaBottomSheetNavigator(
            ...
            setInsetColor(MaterialTheme.colors.background)
            ...
            SendNftConfirmationScreen(
                ...
                onClickTransactionOption = {
                    ...
                    val screen = ScreenRegistry.get(
                        SharedScreen.TransactionFeeScreen(
                ...
                confirmationItems = {
                    ConfirmationItems(
                        ...
                        signTransactionEnabled = (uiState as? SendNftConfirmationScreenUiState.Data)?.selectedTransactionFee != null,
