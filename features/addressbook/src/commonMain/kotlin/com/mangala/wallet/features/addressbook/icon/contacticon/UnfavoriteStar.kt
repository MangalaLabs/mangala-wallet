...
public val ContactIcon.UnfavoriteStar: ImageVector
    get() {
        if (_unfavoriteStar != null) {
            return _unfavoriteStar!!
        }
        _unfavoriteStar = Builder(name = "UnfavoriteStar", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
                viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            group {
                // Star path with yellow color (same as selectedStarTint)
                path(fill = SolidColor(Color.Transparent), stroke = SolidColor(Color(0xFF767676)), strokeLineWidth = 1.0f,
                ...
                // Longer diagonal slash line from top-right to bottom-left with red color
                path(fill = null, stroke = SolidColor(Color(0xFF767676)), strokeLineWidth = 1.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(1.0f, 15.0f)
                    lineTo(15.0f, 1.0f)
...
private var _unfavoriteStar: ImageVector? = null