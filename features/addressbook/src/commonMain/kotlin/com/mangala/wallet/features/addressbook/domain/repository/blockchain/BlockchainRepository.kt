package com.mangala.wallet.features.addressbook.domain.repository.blockchain
...
/**
 * Repository interface cho việc quản lý các thông tin liên quan đến blockchain
 */
interface BlockchainRepository {
    /**
     * Lấy một blockchain type theo ID
     * @param id ID của blockchain type cần lấy
     * @return BlockchainType hoặc null nếu không tìm thấy
     */
     ...
     * @param blockchainType BlockchainType cần lưu
     ...
     * @param blockchainType BlockchainType cần cập nhật
    ...
    /**
     * Lấy danh sách các wallet addresses kèm blockchain type của một contact
     * @param contactId ID của contact
     * @return Danh sách các WalletAddressWithBlockchain
     */
    suspend fun getWalletAddressesWithBlockchainByContactId(contactId: String): List<WalletAddressWithBlockchainModel>

    /**
     * Lưu một wallet address mới
     * @param walletAddress WalletAddress cần lưu
     ...
     * @param walletAddress WalletAddress cần cập nhật
     * @return true nếu cập nhật thành công
     */
     ...
     * @return TokenInformation hoặc null nếu không tìm thấy
     */
     ...
     * @return Danh sách các TokenInformation
     */
     ...
     * @param tokenInformation TokenInformation cần lưu
     ...
     * @param tokenInformation TokenInformation cần cập nhật
     * @return true nếu cập nhật thành công
     */
    ...
    suspend fun getAllActiveBlockchainTypes(): List<BlockchainTypeEntity>
    fun observeBlockchainTypes(): Flow<List<BlockchainTypeEntity>>
}