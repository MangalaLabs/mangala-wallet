...
/**
 * Repository interface cho việc quản lý Settings và các thông tin liên quan
 */
interface SettingsRepository {
    /**
     * Lấy user settings
     * @param id ID của user settings cần lấy (thường là "current" hoặc user ID)
     * @return UserSettings hoặc null nếu không tìm thấy
     */
     ...
     * @return Flow của UserSettings
     */
    fun observeUserSettings(id: String = "current"): Flow<UserSettingEntity?>

    /**
     * Lưu user settings
     * @param settings UserSettings cần lưu
     * @return true nếu lưu thành công
     */
    suspend fun saveUserSettings(settings: UserSettingEntity): Result<Boolean>
     ...
     * @return AppVersion hoặc null nếu không tìm thấy
     */
    suspend fun getCurrentAppVersion(): AppVersionEntity?

    /**
     * Lưu phiên bản app mới
     * @param appVersion AppVersion cần lưu
     * @return true nếu lưu thành công
     */
     ...
     * @return Danh sách các OfflineQueue đang chờ xử lý
     */
    suspend fun getOfflineQueue(): List<OfflineQueueEntity>

    /**
     * Thêm một item vào offline queue
     * @param offlineQueue OfflineQueue cần thêm
     * @return true nếu thêm thành công
     */
     ...
     * @param offlineQueue OfflineQueue cần cập nhật
     * @return true nếu cập nhật thành công
     */
