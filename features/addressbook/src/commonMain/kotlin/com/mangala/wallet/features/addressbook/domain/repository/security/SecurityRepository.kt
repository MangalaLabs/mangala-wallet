package com.mangala.wallet.features.addressbook.domain.repository.security
...
/**
 * Repository interface cho việc quản lý bảo mật và audit logs
 */
interface SecurityRepository {
    /**
     * Lấy một audit log theo ID
     * @param id ID của audit log cần lấy
     * @return SecurityAuditLog hoặc null nếu không tìm thấy
     */
     ...
     * @param securityAuditLog SecurityAuditLog cần lưu
    ...
    /**
     * Kiểm tra xác thực sinh trắc học
     * @return true nếu xác thực thành công
     */
    suspend fun checkBiometricAuth(): Boolean
}