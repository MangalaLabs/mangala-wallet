...
fun SignedTransactionResponse.toSignedTransactionResponseArgs(): SignedTransactionResponseArg {
    return SignedTransactionResponseArg(
        signTransactionRequestArgs = this.signTransactionRequest.toSignTransactionRequestArgs(),
        v = this.v,
        r = this.r,
        s = this.s
    )
