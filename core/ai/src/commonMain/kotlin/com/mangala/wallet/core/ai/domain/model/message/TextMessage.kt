...
data class TextMessage @OptIn(ExperimentalUuidApi::class) constructor(
    ...
    val text: String,
    val uiTags: List<UiTag> = emptyList()
) : Message {
    ...
    override fun deserializeJson(json: String): Message {
        // This is not used by the mapper, which has its own parseTextMessage method
        TODO("Not yet implemented")
    }

    companion object {
        const val CONTENT_TYPE = "text"
    }
}